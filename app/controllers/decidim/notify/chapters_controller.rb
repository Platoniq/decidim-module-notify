    ...
    class ChaptersController < Decidim::Notify::ApplicationController
      ...
      def update
        ...
        UpdateChapter.call(@form) do
          ...
          on(:invalid) do |message|
            render json: { message: t("update.error", scope: "decidim.notify.chapter", message:) }, status: :unprocessable_entity
          end
        end
      end
      ...
      def destroy
        ...
        DeleteChapter.call(params[:id]) do
          ...
          on(:invalid) do |message|
            render json: { message: t("destroy.error", scope: "decidim.notify.chapter", message:) }, status: :unprocessable_entity
          end
        end
      end
    end
